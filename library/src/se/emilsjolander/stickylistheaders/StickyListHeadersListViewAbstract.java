...
public abstract class StickyListHeadersListViewAbstract<C extends ListView & WrapperViewListInterface & AbsListViewHeadersSupport> extends FrameLayout {
    ...
    public StickyListHeadersListViewAbstract(Context context) {
        this(context, null);
    }

    public StickyListHeadersListViewAbstract(Context context, AttributeSet attrs) {
    ...
    public StickyListHeadersListViewAbstract(Context context, AttributeSet attrs, int defStyle) {
        ...
        mList.setLifeCycleListener(new ListLifeCycleListener());
            ...
            mHeader.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    mOnHeaderClickListener.onHeaderClick(
                            StickyListHeadersListViewAbstract.this, mHeader,
    ...
    private class ListLifeCycleListener implements WrapperListViewLifeCycleListener {
    ...
    private class AdapterWrapperHeaderClickHandler implements
        ...
        public void onHeaderClick(View header, int itemPosition, long headerId) {
            mOnHeaderClickListener.onHeaderClick(
                    StickyListHeadersListViewAbstract.this, header, itemPosition,
                    headerId, false);
        }
        ...
        if (l != null) {
            mList.setOnTouchListener(new OnTouchListener() {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    return l.onTouch(StickyListHeadersListViewAbstract.this, event);
                }
            });
        } else {
